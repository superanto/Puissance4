...
public class Statistiques {
	...
	public static final int HvsM = 0; // Type de partie où l'Homme commence
										// contre la Machine
	public static final int MvsH = 1; // Type de partie où l'Homme Ne commence
										// pas contre la Machine
	public static final int HvsH = 2; // Type de partie où deux Hommes
										// s'affrontent
